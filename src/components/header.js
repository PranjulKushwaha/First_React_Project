...
const Header = () => {
    ...
    return (
            ...
            <header className="container text-purple py-4 "  >
                <div className="row">
                    <div className="col-4">

                        <svg className=" " style={{ height: '50px' }} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-8 d-flex justify-content-end align-items-center">
                        <a href='/' className=" text-decoration-none me-4" style={{color:'var(--bs-purple)'}}>Sign in</a>
                        <button className="btn text-light  rounded-0 me-5" style={{backgroundColor:'var(--bs-purple)'}}>Sign up</button>
                    </div>
                </div>
            </header>
